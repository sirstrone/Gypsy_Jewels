    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <c:if test="${adminuser.level=='3'}" var="flag" scope="session">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">货品信息</h3>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <a class="breadcrumb-item" href="/Gypsy_Jewels/creatcargo.jsp">添加其他商品</a>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>${flower.popularity}</td>
                                                <td>${flower.price}</td>
                                                <td><a href="/Gypsy_Jewels/UpdateFlowerDoServlet?id=${flower.id}&adminuserid=${adminuser.id}">修改
                                                </a><a href="/Gypsy_Jewels/DeleteCargoServlet?id=${flower.id}">删除</a>
                                                </td>
                                                <td>
