            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">订单信息</h3>
                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${Book.state!='0'}" var="flag" scope="session">
                                                        完成
                                                    </c:if>
                                                    <c:if test="${not flag}">
                                                        未完成
                                                ...
                                                <td>
                                                    <a href="/Gypsy_Jewels/UpdateBookServlet?uid=${Book.uid}&adminuserid=${adminuser.id}">修改完成状态</a>
                                                </td>
