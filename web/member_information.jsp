                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${User.isvip==1}" var="flag" scope="session">
                                                    是
                                                    </c:if>
                                                    <c:if test="${not flag}">
                                                        否
                                                ...
                                                <td><a href="/Gypsy_Jewels/UpdateUserServlet?uid=${User.uid}&isvip=${User.isvip}&adminuserid=${adminuser.id}">修改VIP权限</a>
                                                </td>
                                                <td>
