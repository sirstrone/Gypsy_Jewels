			...
			<div class=" section-content">
				<div class="row">
					<div class="col-md-12 col-sm-10">
						<form class="reservation-form" action="/Gypsy_Jewels/LoginServlet" id="login" method="post">
							<div class="row">
								<div class="col-md-12 col-sm-10">
								...
								<div class="col-md-6 col-sm-6">
									<button onclick="window.location.href='Regist.jsp'" class="btn btn-reservation">
										<span><i class="fa fa-check-circle-o"></i></span>
										注册
									</button>
								</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="copyright text-center">
						<a href="loginmanagementsys.jsp">管理界面由此进入</a>
					</div>
				</div>
		</div>
	</div>
